...
class HTTP
{
	...
	public function addQueryStringParams($params)
	{
		foreach ($params as $k => $v)
		$this->queryStringParams[$k] = $v;
		return $this;
	}
	...
	public function post()
	{
		...
		$this->response = $this->engine->post($this->request, $this->queryStringParams, $this->getHeaders());
		$this->response = $this->response["body"];
